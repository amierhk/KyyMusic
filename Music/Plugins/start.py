...
def start_pannel():
    buttons = [
        [
            InlineKeyboardButton(text="الجروب​", url=f"https://t.me/{GROUP}"),
            InlineKeyboardButton(text="القناة", url=f"https://t.me/{CHANNEL}"),
        ],
        [
...
pstart_markup = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "➕ ضيف البوت في جروبك ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
        ],
        [
            InlineKeyboardButton(text="الجروب​", url=f"https://t.me/{GROUP}"),
...
💬 [{BOT_NAME}](tg://user?id=2129034376) اهلآ بك في افضل بوت موسيقي في التليجرام ✨

💡كل اوامر البوت موجوده عندك تحت يغالي**
